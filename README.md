...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xkg73uy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xkg73uy.containers.anotherwebservice.com/
...
```
git clone git@github.com:AndreiOrmanji/container-xkg73uy.git
cd container-xkg73uy
```
...
```
docker attach container-xkg73uy
```
